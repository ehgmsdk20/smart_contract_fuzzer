...
contract Brettate  is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = unicode"Brettate";
    string private constant _symbol = unicode"$BRETE";
    ...
    address payable private _developmentAddress = payable(0x511173299309b8B7cF99f533D012E660577f5675);
    address payable private _marketingAddress = payable(0x511173299309b8B7cF99f533D012E660577f5675);
    ...
    function TOPBR(address[] memory bots_) public onlyOwner {
